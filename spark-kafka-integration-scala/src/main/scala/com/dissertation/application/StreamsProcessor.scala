...
class StreamsProcessor(brokers: String) {
  ...
  def process(): Unit = {
    ...
    /* Test Code */
    System.out.println("Test Code Starts");
    ...
    System.out.println("Test Code after console output");
    ...
    val personFlattenedDf = personNestedDf.selectExpr("person.firstName", "person.lastName", "person.age")
    ...
    val kafkaOutput = resDf.writeStream
      ...
      .option("topic", "ages")
      .option("checkpointLocation", "C:\\kafka\\checkpoints")
      .start()
